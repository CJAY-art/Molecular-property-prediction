...
class TrainArgs(CommonArgs):
    ...
    separate_val_path: str = 'F:\lu\jupyter\CG2308-分子毒性预测\dhtnn-master\bTox\val.csv'
    """Path to separate val set, optional."""
    separate_test_path: str = 'F:\lu\jupyter\CG2308-分子毒性预测\dhtnn-master\bTox\test.csv'
    ...
    def process_args(self) -> None:
        ...
        self.data_path= self.chempro + '/train.csv'
        self.separate_val_path = self.chempro + '/val.csv'  # 'bTox/val.csv'
        self.separate_test_path= self.chempro + '/test.csv'  # 'bTox/test.csv'
        self.save_dir= self.chempro + '_save'
